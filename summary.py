...
def summary_main():
    ...
    if stock == 'AAPL':
        pdf_file = r"D:\aaaaStockMarket\aaaaaaa_SA_DOCKERRRRR\stock-master\reports\aapl.pdf"
    elif stock == 'AMZN':
        pdf_file = r"D:\aaaaStockMarket\aaaaaaa_SA_DOCKERRRRR\stock-master\reports\amzn.pdf"
    elif stock == 'MSFT':
        pdf_file = r"D:\aaaaStockMarket\aaaaaaa_SA_DOCKERRRRR\stock-master\reports\msft.pdf"
    elif stock == 'GOOG':
        pdf_file = r"D:\aaaaStockMarket\aaaaaaa_SA_DOCKERRRRR\stock-master\reports\googl.pdf"
    elif stock == 'TSLA':
        pdf_file = r"D:\aaaaStockMarket\aaaaaaa_SA_DOCKERRRRR\stock-master\reports\tsla.pdf"
    elif stock == 'NVDA':
        pdf_file = r"D:\aaaaStockMarket\aaaaaaa_SA_DOCKERRRRR\stock-master\reports\nvda.pdf"
    elif stock == 'COST':
        pdf_file = r"D:\aaaaStockMarket\aaaaaaa_SA_DOCKERRRRR\stock-master\reports\cost.pdf"
    elif stock == 'ADBE':
        pdf_file = r"D:\aaaaStockMarket\aaaaaaa_SA_DOCKERRRRR\stock-master\reports\adbe.pdf"
    elif stock == 'META':
        pdf_file = r"D:\aaaaStockMarket\aaaaaaa_SA_DOCKERRRRR\stock-master\reports\meta.pdf"
    else:
        pdf_file = r"D:\aaaaStockMarket\aaaaaaa_SA_DOCKERRRRR\stock-master\reports\wmt.pdf"
    ...
    for i, summary in enumerate(summaries):
        st.write(f"Page {i + start_page}: {summary}\n")
