...
job=pd.read_csv(r"D:\\aaaaStockMarket\\SA_kube\\job (1).csv")
...
Labour=pd.read_csv(r"D:\\aaaaStockMarket\\SA_kube\\Labour (1).csv")
...
Manufacture_indexing=pd.read_csv(r"D:\\aaaaStockMarket\\SA_kube\\Manufacture_indexing (1).csv")
...
CPI=pd.read_csv(r"D:\\aaaaStockMarket\\SA_kube\\CPI (1).csv")
...
inflation=pd.read_csv(r"D:\\aaaaStockMarket\\SA_kube\\inflation (2).csv")

Housing=pd.read_csv(r"D:\\aaaaStockMarket\\SA_kube\\housing_new_gg (1).csv")
...
nasdaq=pd.read_csv(r"D:\\aaaaStockMarket\\SA_kube\\NASDAQCOM.csv")
...
if st.button('Predict'):
    ...
    ica = picard.Picard(n_components=75, random_state=42)
